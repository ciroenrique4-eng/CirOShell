...
hl.curve("slideClean", { type = "bezier", points = { { 0.16, 1 }, { 0.3, 1 } } })

-- Animaciones
hl.animation({ leaf = "layersIn", enabled = true, speed = 5, bezier = "slideClean", style = "slide" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 5, bezier = "slideClean", style = "slide" })
